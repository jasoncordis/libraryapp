...
app.use("/api/contacts/delete", require("./routes/contacts"));
...
app.use("/api/journals/viewer", require("./routes/journals"));
app.use("/api/magazines", require("./routes/magazines"));
app.use("/api/magazines/viewer", require("./routes/magazines"));
